<%@ page import="by.girafic.core.contentdata.SectionViewModifyData" %>
...
<%--@elvariable id="Section" type="by.girafic.core.contentdata.SectionViewModifyData"--%>
    ...
    <%
        ...
        if(section!=null)
            request.setAttribute("CurrentContent",
                    Arrays.stream(section.contents.value)
                            .boxed()
